    ...
    const getSnapshotUri = () => {
      ...
      if (profile) {
        ...
        this.services.media.getSnapshotUri(params, (error, result) => {
          ...
          // For Hikvision-style cameras, construct channel-based snapshot URL from RTSP stream
          // This is needed because some cameras ignore the ONVIF profile parameter in snapshot URLs
